    const getProducts = async () => {
        const url = "https://raw.githubusercontent.com/cadebehnke/cadebehnke.github.io/refs/heads/main/Projects/part3-better/json/items.json"; // Use the raw GitHub link
    ...
    const showWomenProducts = async () => {
        ...
        if (!womenSection) return; // Ensure script only runs on the women page
